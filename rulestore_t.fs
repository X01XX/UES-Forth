: rulestore-test-union
    ...
    s" 00/11/00/11/" rule-from-string-a rulestore-new-1
    s" 11/11/00/11/" rule-from-string-a rulestore-new-1
    2dup rulestore-union                \ rs1 rs2, rs3 t | f
    ...
    s" 00/11/00/11/" rule-from-string-a
     rulestore-new-1
    s" 11/11/00/10/" rule-from-string-a rulestore-new-1
    2dup rulestore-union                \ rs1 rs2, rs3 t | f
    ...
    s" 00/11/00/11/" rule-from-string-a \ rul1
    s" 00/11/00/10/" rule-from-string-a \ rul1 rul2
    rulestore-new-2                     \ rs1
    cr ." rulestore1: " dup .rulestore cr

    s" 00/11/11/11/" rule-from-string-a \ rs1 rul1
    s" 00/11/11/10/" rule-from-string-a \ rs1 rul1 rul2
    ...
    \ Try different order.
    s" 00/11/11/10/" rule-from-string-a \ rs1 rul1
    s" 00/11/11/11/" rule-from-string-a \ rs1 rul1 rul2
    ...
    s" 01/11/11/00/" rule-from-string-a \ rs1 rul1
    s" 00/11/11/00/" rule-from-string-a \ rs1 rul1 rul2
    ...
    s" 11/11/11/00/" rule-from-string-a \ rs1 rul1
    s" 11/11/11/01/" rule-from-string-a \ rs1 rul1 rul2
