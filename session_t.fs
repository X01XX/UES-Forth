...
: session-test-fc
    ...
    %1011 %1111 sample-new dup #2 pick action-add-sample sample-deallocate  \ dom act0
    ...
    %0111 %0101 sample-new dup rot action-add-sample sample-deallocate      \ dom
    ...
    domain-get-plan                             \ dom reg-to reg-from, plan t | f
    if
        cr ." plan " dup .plan cr
